...
# 属性词态度词匹配用测试集
MATCH_TEST_REVIEW = 'data/match_Test_review.csv'
MATCH_TEST_LABEL = 'data/match_Test_label.csv'
MATCH_FEATURE_SENTS_TEST = 'data/feature_sents_matchc_test.pkl'
TASK1_TEST = 'results/task1_test.csv'
