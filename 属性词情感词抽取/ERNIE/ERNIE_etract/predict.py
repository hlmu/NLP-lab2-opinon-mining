...
import csv
from config import TEST_REVIEW
...
# test data
    ...
    with open('data/temp_out.txt', 'w', encoding='utf-8') as f:
        for num_batch, batch_results in enumerate(results):
            ...
            for index, np_len in enumerate(np_lens):
                ...
                f.write('%d,%s,%s\n'% (num_batch * args.batch_size + index, data[num_batch * args.batch_size + index][0], label_str[1:-1]))
