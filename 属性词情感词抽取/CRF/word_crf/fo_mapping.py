...
from config import FEATURE_SENTS_TRAIN, FEATURE_SENTS_TEST, FOR_MODEL, TASK1_ANS, MATCH_FEATURE_SENTS_TEST, \
    TASK1_TEST, MATCH_TEST_LABEL
from utils.feature_extraction import sent2features, sent2labels, sent2index
from eval31 import evaluate

with open(FEATURE_SENTS_TRAIN, 'rb') as f:
    train_sents = pickle.load(f)

# with open(MATCH_FEATURE_SENTS_TEST, 'rb') as f:
...
# cnt = 0
# with open(TASK1_TEST, 'w', encoding='utf-8') as f:
...
# print(evaluate(MATCH_TEST_LABEL, TASK1_TEST))