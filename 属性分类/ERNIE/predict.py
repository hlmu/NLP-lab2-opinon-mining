...
if __name__ == '__main__':
    ...
    data = []
    task1_ans = []
    with codecs.open(TASK1_ANS, "r", encoding="UTF-8") as f:
        reader = csv.reader(f)
        examples = []
        seq_id = 0
        for line in reader:
            ...
            task1_ans.append((line[0], line[1], line[2]))
            data.append([feature+opinion])


    with open(TASK2_ANS, 'w', encoding='utf-8') as f:
        index = 0
        ...
        for batch_result in results:
            ...
            for result in batch_result:
                ...
                f.write("%s,%s,%s,%s\n" % (task1_ans[index][0], task1_ans[index][1], task1_ans[index][2], CATEGORIES[result]))
                index += 1
